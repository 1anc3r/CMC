package me.lancer.cmc.ui.activity;
...
import me.lancer.cmc.mvp.base.activity.BaseActivity;
import me.lancer.cmc.ui.adapter.SettingAdapter;
import me.lancer.cmc.ui.application.mApp;
import me.lancer.cmc.ui.application.mParams;
...
//        funcList.add("四六级 : 查询英语四六级考试成绩, 包括听力、阅读、综合、写作和总分");
        problemList.add("教务处 : 请使用成都医学院教务管理系统的账号和密码登录");
...
//        problemList.add("应用内意见反馈通道尚未开启, 遇到Bug请发送邮件至huangfangzhi0@foxmail.com");
    ...
    private void showDownloadDialog(){
        ...
        TextView tvCmcDownload = (TextView) downloadDialogView.findViewById(R.id.tv_cmc_download);
        tvCmcDownload.setOnClickListener(new View.OnClickListener() {
...
//                startActivity(intent);
        ...
        TextView tvCmcBlog = (TextView) downloadDialogView.findViewById(R.id.tv_cmc_blog);
        tvCmcBlog.setOnClickListener(new View.OnClickListener() {
...
//                startActivity(intent);
        ...
        TextView tvCmcGithub = (TextView) downloadDialogView.findViewById(R.id.tv_cmc_github);
        tvCmcGithub.setOnClickListener(new View.OnClickListener() {
