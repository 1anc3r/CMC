package me.lancer.cmc.mvp.loginedu.activity;
...
import me.lancer.cmc.mvp.base.activity.PresenterActivity;
import me.lancer.cmc.mvp.loginedu.ILoginEduView;
...
import me.lancer.cmc.ui.view.ClearEditText;
import me.lancer.cmc.util.NetworkDiagnosis;
...
public class LoginEduActivity extends PresenterActivity<LoginEduPresenter> implements ILoginEduView {
    ...
    private void initData() {
        ...
        app.setScore(true);
        app.setUser(true);
        if (new File(root + getString(R.string.path_course) + number).exists() && new File(root + getString(R.string.path_score) + number).exists() && new File(root + getString(R.string.path_user) + number).exists() && new File(root + getString(R.string.path_level) + number).exists()) {
